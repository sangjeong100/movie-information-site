...
function ajaxTrendingUpdate(data){
  ...
  xhr.onload = function(){
    if(xhr.status === 200 || xhr.status === 201){
      ...
      let star = document.querySelector(`#starPosition_${movie._id}`);
      if(star.childNodes[0].src === "http://localhost:3000/images/NoTrending_star.png")
